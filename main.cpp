...
void detectEdges(Image img) {
	...
	gray_img.write("output/1 - gray.png");
	...
	blur_img.write("output/2 - blur.png");
	...
	Gx.write("output/3 - Gx.png");
	Gy.write("output/3 - Gy.png");
	...
	G.write("output/4 - G.png");
	GT.write("output/4 - GT.png");
